...
model.add(keras.layers.Dense(256, input_shape=(len(train_x[0]),), name="inp_layer", activation='relu'))
model.add(keras.layers.Dropout(0.3, name="hidden_layer1"))
model.add(keras.layers.Dense(128, name="hidden_layer2", activation='relu'))
model.add(keras.layers.Dropout(0.3, name="hidden_layer3"))

model.add(keras.layers.Dense(len(train_y[0]), name="output_layer", activation='softmax'))
